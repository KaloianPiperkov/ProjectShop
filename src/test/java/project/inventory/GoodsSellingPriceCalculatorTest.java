...
class GoodsSellingPriceCalculatorTest {
    ...
    void calculateSellingPrice() {
        ...
        Goods goods = new Goods(1L, "Apple", BigDecimal.valueOf(10), Category.FOOD, LocalDate.now().plusDays(5), 10, goodsSellingPriceCalculator);

        BigDecimal expectedSellingPrice = BigDecimal.valueOf(10.25);
        assertEquals(expectedSellingPrice, goodsSellingPriceCalculator.calculateSellingPrice(goods));
    }
}