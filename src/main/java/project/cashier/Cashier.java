...
public class Cashier {
    ...
    public Cashier(String name_of_cashier, long id_of_cashier, double salary_of_cashier_per_hour, int hour_worked) {
    ...
    public double getSalary_of_cashier_per_hour() {
        return salary_of_cashier_per_hour;
    }
    ...
    public String toString() {
        return "Cashier{" +
                ...
                ", salary_of_cashier_per_hour=" + salary_of_cashier_per_hour +
